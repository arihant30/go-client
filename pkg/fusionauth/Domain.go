...
type SCIMEnterpriseUser struct {
  ...
  Manager                          SCIMMember                         `json:"manager,omitempty"`
...
func (b *ScimListResponse) SetStatus(status int) {
  b.StatusCode = status
}
...
type ScimResourceResponse struct {
  BaseHTTPResponse
  Emails                           []map[string]interface{}           `json:"emails,omitempty"`
  EnterpriseUserExtension          map[string]interface{}             `json:"enterpriseUserExtension,omitempty"`
  ExternalId                       string                             `json:"externalId,omitempty"`
  Id                               string                             `json:"id,omitempty"`
  Meta                             map[string]string                  `json:"meta,omitempty"`
...
func (b *ScimResourceResponse) SetStatus(status int) {
  b.StatusCode = status
}

type ScimResourceType string
const (
  ScimResourceType_Users                            ScimResourceType                   = "Users"
  ScimResourceType_EnterpriseUsers                  ScimResourceType                   = "EnterpriseUsers"
  ScimResourceType_Groups                           ScimResourceType                   = "Groups"
)
...
func (b *ScimSchemasResponse) SetStatus(status int) {
  b.StatusCode = status
}
...
func (b *ScimServiceProviderConfigResponse) SetStatus(status int) {
  b.StatusCode = status
}

type ScimTarget string
const (
  ScimTarget_Users                            ScimTarget                         = "Users"
  ScimTarget_EnterpriseUsers                  ScimTarget                         = "EnterpriseUsers"
  ScimTarget_Groups                           ScimTarget                         = "Groups"
  ScimTarget_Bulk                             ScimTarget                         = "Bulk"
  ScimTarget_ServiceProviderConfig            ScimTarget                         = "ServiceProviderConfig"
  ScimTarget_ResourceTypes                    ScimTarget                         = "ResourceTypes"
  ScimTarget_Schemas                          ScimTarget                         = "Schemas"
)
...
type SCIMUser struct {
  BaseSCIMResource
  Active                           bool                               `json:"active"`
  Addresses                        []SCIMUserAddress                  `json:"addresses,omitempty"`
  DisplayName                      string                             `json:"displayName,omitempty"`
  Emails                           []SCIMUserEmail                    `json:"emails,omitempty"`
  Entitlements                     []string                           `json:"entitlements,omitempty"`
  Groups                           []SCIMGroup                        `json:"groups,omitempty"`
  Ims                              []SCIMUserIMS                      `json:"ims,omitempty"`
  Locale                           string                             `json:"locale,omitempty"`
  Name                             SCIMUserName                       `json:"name,omitempty"`
  NickName                         string                             `json:"nickName,omitempty"`
  Password                         string                             `json:"password,omitempty"`
  PhoneNumbers                     []SCIMUserPhoneNumber              `json:"phoneNumbers,omitempty"`
  Photos                           []SCIMUserPhoto                    `json:"photos,omitempty"`
